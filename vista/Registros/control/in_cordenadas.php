...
$map_img = (isset($_POST['base64'])) ? $_POST['base64'] : '';
...
$stmt->bindParam(4, $cx, PDO::PARAM_STR, 70);
$stmt->bindParam(5, $cy, PDO::PARAM_STR, 70);
$stmt->bindParam(6, $tutor, PDO::PARAM_STR, 70);
$stmt->bindParam(7, $telCasa, PDO::PARAM_STR, 70);
$stmt->bindParam(8, $telMovil, PDO::PARAM_STR, 70);
$stmt->bindParam(9, $map_img, PDO::PARAM_LOB, 70);
