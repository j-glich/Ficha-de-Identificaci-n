...
echo '<table border = 1>';
echo '<tr>';
echo '<th colspan=57>Reporte Ficha de Identificación</th>';
echo '</tr>';
echo '<tr>
...
<th>ANG_EST_CIVIL</th><th>ANG_DOMICILIO</th><th>ANG_HIJOS</th><th>ANG_CUANTOS</th><th>ANG_FECHA_APL</th><th>AE_TIPO_ESC</th><th>AE_ESPECIALIDAD</th><th>AE_NOM_ESC</th><th>AE_PROMEDIO</th><th>AE_BECA</th><th>AE_VIVE_CON</th><th>AE_TIPO_BECA</th><th>AE_OTRO_TB</th>
<th>ANGS_PRO_SALUD</th><th>ANGS_ESPECIFIQUE</th><th>ANGS_TIP_SANGRE</th><th>ANGS_ALERGIAS</th><th>ANGS_TIP_ALERGIA</th><th>ANGS_ESP_ALERGIA</th><th>ANGS_DIS_SENSORIAL</th><th>ANGS_DIS_MOTORA</th>
<th>ANGS_ESP_DIS_MOTORA</th><th>ANGS_DIS_TEMPORAL</th><th>ANGS_TIPO_DIS</th><th>ANL_TRABAJO</th><th>ANL_NOM_TRABAJO</th><th>ANL_HORARIO</th><th>ANL_DEP_ECONO</th><th>ANL_ESP_DEP</th><th>ANL_ING_MEN_FAMILIAR</th><th>ANL_ING_MEN_PERSONAL</th>
<th>ANL_DOMICILIO</th><th>ANL_ESC_PADRE</th><th>ANL_EST_DEF_PA</th><th>ANL_OC_PADRE</th><th>ANL_ESC_MADRE</th><th>ANL_EST_DEF_MA</th><th>ANL_OC_MADRE</th><th>ANLO_CALLE</th><th>ANLO_MUNICIPIO</th><th>ANLO_COLONIA</th>
